...
class IsaacROSSegformerLaunchFragment(IsaacROSLaunchFragment):
    ...
    def get_composable_nodes(interface_specs: Dict[str, Any]) -> Dict[str, ComposableNode]:
        ...
        return {
            'segformer_triton_node': ComposableNode(
                name='segformer_triton_node',
    ...
    def get_launch_actions(interface_specs: Dict[str, Any]) -> \
        ...
        return {
            ...
            'segformer_encoder_launch': IncludeLaunchDescription(
                ...
                launch_arguments={
                    ...
                    'dnn_image_encoder_namespace': 'segformer_encoder',
