...
#define NVIDIA_ISAAC_ROS_GXF_EXTENSIONS_SEGMENT_ANYTHING_POSTPROCESSOR_HPP_
...
class SegmentAnythingPostprocessor : public gxf::Codelet {
 public:
...
#endif  // NVIDIA_ISAAC_ROS_GXF_EXTENSIONS_SEGMENT_ANYTHING_POSTPROCESSOR_HPP_
