...
#define NVIDIA_ISAAC_ROS_GXF_EXTENSIONS_SEGMENT_ANYTHING_MSG_COMPOSITOR_HPP_
...
class SegmentAnythingMsgCompositor : public gxf::Codelet {
 public:
...
#endif  // NVIDIA_ISAAC_ROS_GXF_EXTENSIONS_SEGMENT_ANYTHING_MSG_COMPOSITOR_HPP_
