...
def generate_launch_description():
    ...
    resize_node = ComposableNode(
        ...
        remappings=[('/resize/image', '/segment_anything/resized_image')]
    )
    ...
    data_preprocessor_node = ComposableNode(
        ...
        remappings=[('prompts', 'detectnet/detections'),
    ...
    container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[resize_node, pad_node, image_format_converter_node,
